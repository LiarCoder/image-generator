...
class ColorProcessor {
   ...
   */
  autoTextColor(bgHex) {
    const lum = this.relativeLuminance(this.hexToRgb(bgHex));
   ...
   */
  resolve(bgColorOpt, textColorOpt) {
    const bgColor = bgColorOpt ?? this.randomMutedColor();
    const textColor = textColorOpt ?? this.autoTextColor(bgColor);
